...
go build -v -ldflags="-X 'github.com/cryft-labs/cryft-cli/cmd.Version=$VERSION' -X github.com/cryft-labs/cryft-cli/pkg/utils.telemetryToken=$TELEMETRY_TOKEN" $extra_build_args -o $BIN
